      ...
      <div class="card">
          ...
          <div class="card-header">
              ...
              <div class="card-body">
                ...
                <tbody>
                    <?php $i = 1 ?>
                    <?php foreach($transactions as $att): ?>
                    <tr>
                        <td><?= $i++; ?></td>
                        <td><?= $att['no_struk_transaksi']; ?></td>
                        <td><?= $rupiahFormatter->formatRupiah($att['total_transaksi']);  ?></td>
                        <td>
                          <a  href="/todaytransactions/<?= $att['no_struk_transaksi']?>" class="btn btn-success">View Details</a>
                        </td>
                    </tr> 
                      <?php endforeach; ?>
                </tbody>
